...
<h4>Welcome to Update Folio Page</h4>
<form:form class="form-horizontal" action="processUpdateFolio.form" method="post" modelAttribute="folioForm">
	...
	<div class="input-group">
		...
		<form:input class="form-control" path="folioNumber" type="text" maxlength="20"  readonly="true"/>
	</div>
	<div class="input-group">
